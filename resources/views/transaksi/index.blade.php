        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="d-flex justify-content-between align-items-start mb-4">
                <div>
                    ...
                    <p class="text-muted mb-0">Monitor sirkulasi log peminjaman dan pengembalian buku.</p>
                </div>
                <a href="{{ route('transaksi.create') }}" class="btn btn-danger">
                                    ...
                                    <td>
                                        @if($transaksi->status == 'Dipinjam')
                                            ...
                                            @if(now() > $transaksi->tanggal_kembali)
                                                <span class="badge bg-danger">Terlambat {{ $transaksi->terlambat_format }}</span>
                                            @endif
                                        @else
